...
<br>
녹음을 하는 스크린이다. 스크린 중앙에 위치한 녹음 아이콘이 있는 버튼을 누르면 녹음이 시작된다. 녹음을 시작하고 말하게 되면 말한 내용이 텍스트로 변환되어 녹음 버튼 위에서 보이게 된다. 녹음이 완료되면 사용자에게 Alert를 통해 녹음이 끝나 타임라인에 반영된다고 알려준다.<br>
<br>
